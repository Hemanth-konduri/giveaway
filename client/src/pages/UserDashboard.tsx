      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        ...
        >
          <div className="flex items-center justify-between mb-6">
            ...
            <Link to="/campaigns" className="text-primary font-semibold hover:underline flex items-center gap-2">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/campaigns" className="bg-primary hover:bg-primary/90 text-white font-semibold px-8 py-3 rounded-lg transition-colors">
              Browse Campaigns
            </Link>
            <Link to="/volunteer" className="border border-primary text-primary hover:bg-primary/5 font-semibold px-8 py-3 rounded-lg transition-colors">
              Become a Volunteer
            </Link>
          </div>
        </motion.div>
